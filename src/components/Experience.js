    ...
    <div className="my-64 md:my-20 xs:my-32">
      ...
      <div ref={ref} className="w-[75%] mx-auto relative lg:w-[90%] md:w-full">
        ...
        <ul className="w-full flex flex-col items-end justify-between ml-4 xs:ml-2">
          ...
          <Details
            position="International Outbound Telesales Agent"
            company="Afir Technologies"
            companyLink="https://www.facebook.com/Afirtech/"
            time="2021-2022"
            address="29-Commercial Area Cavalry Ground , LHR"
