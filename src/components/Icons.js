...
export const TwitterIcon = ({ className, ...rest }) => (
  <svg
    ...
    className={`w-full h-auto ${className}`}
  >
    <path d="M40.9 32.8c-4.3 2.2-5.9 3.8-8.1 8.1L30 46.2v147.6l2.8 5.3c2.2 4.3 3.8 5.9 8.1 8.1l5.3 2.8h147.6l5.3-2.8c4.3-2.2 5.9-3.8 8.1-8.1l2.8-5.3V46.2l-2.8-5.3c-2.2-4.3-3.8-5.9-8.1-8.1l-5.3-2.8H46.2l-5.3 2.8zM113.4 87c6.4 9.3 12 17 12.4 16.9.4 0 7.2-7.7 15.2-17L155.5 70h4.8c2.6 0 4.7.2 4.7.5s-7.5 9.1-16.6 19.7c-9.1 10.5-16.8 19.7-17.1 20.4-.3.8 8.6 14.3 19.6 30.1l20.1 28.8-15.7.3c-11.7.2-16-.1-16.9-1-.7-.7-6.7-9.2-13.4-18.8-6.7-9.6-12.3-17.6-12.5-17.8-.1-.1-7.6 8.3-16.6 18.8l-16.4 19H69l19-21.9c10.4-12.1 19-22.4 19-22.9 0-.8-17.2-25.8-33.7-49L68.9 70h32.7l11.8 17z" />
    <path d="M86.2 80c.2.5 12.9 18.9 28.3 40.9l28 40 6.3.1c5 0 6.1-.3 5.5-1.3-.4-.8-13.4-19.2-28.7-41L97.7 79h-5.9c-3.4 0-5.8.4-5.6 1z" />
  </svg>
);
// #0A66C2
